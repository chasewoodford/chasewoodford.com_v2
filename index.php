...
<header role="banner" id="home">
    ...
    <div class="row banner">
        <div class="banner-text">
            ...
            <h3>I'm Chase Woodford, a <span>web designer</span> and <span>developer</span> living in the suburbs of
...
<section id="journal">
    ...
    <div class="row text-center view-more">
        <p>
            <a href="archive.php" class="button view-more"><i class="fa fa-external-link"></i>View More Posts</a>
        </p>
    </div>
    <hr class="row"/>
