                ...
                <article role="article" class="post">
                    ...
                    <div class="post-content">
                        ...
                        <ul class="post-nav clearfix">
                            <li class="prev"><a class="no-underline" rel="prev" href="#"><strong>Previous Article</strong> Duis Sed Odio Sit Amet Nibh Vulputate</a></li>
                            <li class="next"><a class="no-underline" rel="next" href="#"><strong>Next Article</strong> Morbi Elit Consequat Ipsum</a></li>
                        </ul>
                ...
                <div id="comments">
                    ...
                    <ol class="commentlist">
                        ...
                        <li class="depth-1">
                            ...
                            <div class="avatar">
                                <img width="50" height="50" class="avatar" src="images/user.png" alt="">
                            </div>
                            ...
                            <div class="comment-info">
                                ...
                                <div class="comment-meta">
                                    <time class="date" datetime="2014-01-14T23:05">Jan 14, 2013</time> / <a class="reply no-underline" href="#">Reply</a>
                                </div>
                            </div>
                        ...
                        <li class="thread-alt depth-1">
                            ...
                            <div class="comment-info">
                                ...
                                <div class="comment-meta">
                                    <time class="date" datetime="2014-01-14T24:05">Jan 14, 2013</time> / <a class="reply no-underline" href="#">Reply</a>
                                </div>
                            </div>
                            ...
                            <ul class="children">
                                ...
                                <li class="depth-2">
                                    ...
                                    <div class="comment-info">
                                        ...
                                        <div class="comment-meta">
                                            <time class="date" datetime="2014-01-14T25:05">Jan 14, 2013</time> / <a class="reply no-underline" href="#">Reply</a>
                                        </div>
                                    </div>
                                    ...
                                    <ul class="children">
                                        ...
                                        <li class="depth-3">
                                            ...
                                            <div class="comment-info">
                                                ...
                                                <div class="comment-meta">
                                                    <time class="date" datetime="2014-01-14T25:15">Jan 14, 2013</time> / <a class="reply no-underline" href="#">Reply</a>
                                                </div>
                                            </div>
                    ...
                    <div class="respond">
                        ...
                        <form name="contactForm" id="contactForm" method="post" action="">
                            <fieldset>
                                ...
                                <div class="clearfix">
                                    <label for="commentMessage">Message <span class="required">*</span></label>
                                    <textarea cols="50" rows="15" id="commentMessage" name="commentMessage"></textarea>
                                </div>

                                <div class="clearfix">
                                    <button class="submit" type="submit"><i class="fa fa-paper-plane"></i>&nbsp;Submit</button>
